<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="extra.aspx.cs" Inherits="Sgipc_kuet_latest.extra" %>
    ...
    <asp:Button ID="Button14" runat="server" cssclass="mybtn" Text="Profile" OnClick="Button3_Click14" />
        ...
        <div>
            <br />
             ...
             &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                  <asp:Table ID="myTable" runat="server"  BorderColor="Black"  Style="word-break: break-all;width:80%"
    BorderWidth="5" cellpadding="5" cellspacing="5" ForeColor="Black" GridLines="Both"  BorderStyle="Solid" CssClass="bg-light60"> 
    <asp:TableRow >
        <asp:TableCell Style="word-break:normal;  Width:10% " >User Name</asp:TableCell>
        <asp:TableCell Style="word-break:normal;">BLOG TEXT</asp:TableCell>
    </asp:TableRow>
</asp:Table>
        </div>
    </form>
