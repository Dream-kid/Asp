<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="regis.aspx.cs" Inherits="Sgipc_kuet_latest.regis" %>
...
&nbsp;&nbsp;&nbsp;
    <asp:Button ID="Button5" runat="server" cssclass="mybtn" Text="Contact" OnClick="Button3_Click1" />
     &nbsp;&nbsp;&nbsp;
    <asp:Button ID="Button14" runat="server" cssclass="mybtn" Text="Blog" OnClick="Button3_Click14" />
</div>
        <br />
                <br />
        ...
        <div>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <asp:Table ID="myTable" runat="server"  BorderColor="Black"  Style="word-break: break-all;width:auto"
    BorderWidth="10"  cellpadding="10" cellspacing="10" ForeColor="Black" GridLines="Both"  BorderStyle="Solid" CssClass="bg-light60"> 
