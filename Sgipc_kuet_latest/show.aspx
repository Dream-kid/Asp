<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="show.aspx.cs" Inherits="Sgipc_kuet_latest.show" %>
...
&nbsp;&nbsp;&nbsp;
    ...
    &nbsp;&nbsp;&nbsp;
    <asp:Button ID="Button6" runat="server" cssclass="mybtn" Text="Profile" OnClick="Button6_Click1" style="height: 38px" />
</div>
